...
## Project Structure
    ...
    ├── trust_business_bank_44194  # Django project configurations
...
1. Clone this repo and `cd trust_business_bank_44194`
...
2. Clone this repo and `cd trust_business_bank_44194`
